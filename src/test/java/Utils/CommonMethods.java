...
public class CommonMethods  extends PageInitializer {
    ...
    public static void openBrowserAndLaunchApplication() {
        ...
        // PageInitializer class along with the launching of the application
    ...
    public static byte[] takeScreenshot(String imageName){
       ...
       File sourcePath=ts.getScreenshotAs(OutputType.FILE);
        ...
        try {
            FileUtils.copyFile(sourcePath, new File(Constants.SCREENSHOT_FILEPATH+imageName+getTimeStamp("yyyy-mm-dd-mm-ss")+".png"));
        } catch (IOException e) {
